...
//
//             LMStudioApiSettings apiSettings = new()
//             {
//                 URL = "apiUrl",
//                 ChatRoute = "route",
//                 Model = "model",
...
//
//             LMStudioApiSettings lmSettings = new()
//             {
//                 URL = "asdadjaod",
...
//             Logger<LMStudioApi> apiLogger = (Logger<LMStudioApi>)LoggerFactory.Create(b => b.AddConsole());
//
//             var repo = new ChatRepo(_context);
//             var api = new LMStudioApi(apiOptions, apiLogger);
